...
#set_property PACKAGE_PIN U9 [get_ports {entrada_pi[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {entrada_pi[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports {entrada_pi[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {entrada_pi[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {entrada_pi[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {entrada_pi[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
#set_property PACKAGE_PIN R6 [get_ports {entrada_pi[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {entrada_pi[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
#set_property PACKAGE_PIN R5 [get_ports {entrada_pi[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {entrada_pi[4]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
#set_property PACKAGE_PIN V7 [get_ports {entrada_pi[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {entrada_pi[5]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
#set_property PACKAGE_PIN V6 [get_ports {entrada_pi[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {entrada_pi[6]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
#set_property PACKAGE_PIN V5 [get_ports {entrada_pi[7]}]					
   #set_property IOSTANDARD LVCMOS33 [get_ports {entrada_pi[7]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
#set_property PACKAGE_PIN U4 [get_ports {d_i[8]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_i[8]}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
#set_property PACKAGE_PIN V2 [get_ports {addr_pi[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {addr_pi[0]}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
#set_property PACKAGE_PIN U2 [get_ports {addr_pi[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {addr_pi[1]}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
#set_property PACKAGE_PIN T3 [get_ports {d_i[11]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_i[11]}]
##Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = SW12
#set_property PACKAGE_PIN T1 [get_ports {d_i[12]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_i[12]}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
#set_property PACKAGE_PIN R3 [get_ports {d_i[13]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_i[13]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
#set_property PACKAGE_PIN P3 [get_ports {d_i[14]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_i[14]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
#set_property PACKAGE_PIN P4 [get_ports {reg_sel_pi}]					
...
#set_property PACKAGE_PIN T8 [get_ports {salida_po[0]}]
    #set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[0]}]
    ##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports {salida_po[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[1]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {salida_po[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[2]}]
##Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {salida_po[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[3]}]
##Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN T5 [get_ports {salida_po[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[4]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {salida_po[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[5]}]
##Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {salida_po[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[6]}]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
#set_property PACKAGE_PIN U6 [get_ports {salida_po[7]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[7]}]
##Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
#set_property PACKAGE_PIN V4 [get_ports {salida_po[8]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[8]}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
#set_property PACKAGE_PIN U3 [get_ports {salida_po[9]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[9]}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
#set_property PACKAGE_PIN V1 [get_ports {salida_po[10]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[10]}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
#set_property PACKAGE_PIN R1 [get_ports {salida_po[11]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[11]}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
#set_property PACKAGE_PIN P5 [get_ports {salida_po[12]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[12]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
#set_property PACKAGE_PIN U1 [get_ports {salida_po[13]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[13]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {salida_po[14]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {salida_po[14]}]
...
set_property PACKAGE_PIN L3 [get_ports {hex_number_po[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[6]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {hex_number_po[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[5]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {hex_number_po[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[4]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {hex_number_po[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {hex_number_po[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[2]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {hex_number_po[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[1]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {hex_number_po[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[0]}]
...
set_property PACKAGE_PIN F15 [get_ports boton_pi]						
	set_property IOSTANDARD LVCMOS33 [get_ports boton_pi]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
#set_property PACKAGE_PIN T16 [get_ports sel_i[1]]						
	#set_property IOSTANDARD LVCMOS33 [get_ports sel_i[1]]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
#set_property PACKAGE_PIN R10 [get_ports sel_i[0]]						
	#set_property IOSTANDARD LVCMOS33 [get_ports sel_i[0]]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports boton_7seg_pi]						
	set_property IOSTANDARD LVCMOS33 [get_ports boton_7seg_pi]
 


##Pmod Header JA
##Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = JA1
set_property PACKAGE_PIN B13 [get_ports {cs_po}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cs_po}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {mosi_po}]					
...
set_property PACKAGE_PIN E17 [get_ports {sclk_po}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sclk_po}]
...
create_generated_clock -name clk_pll -source [get_ports clk_pi] -divide_by 10 [get_pins reloj_10M/clk_10MHz]
