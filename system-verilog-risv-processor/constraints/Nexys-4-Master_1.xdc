...
set_property PACKAGE_PIN L3 [get_ports {hex_number_po[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[0]}]
#Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {hex_number_po[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[1]}]
#Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {hex_number_po[2]}]					
...
set_property PACKAGE_PIN K3 [get_ports {hex_number_po[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[4]}]
#Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {hex_number_po[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hex_number_po[5]}]
#Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {hex_number_po[6]}]					
...
set_property PACKAGE_PIN N6 [get_ports {an_po[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_po[0]}]
#Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {an_po[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_po[1]}]
#Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {an_po[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_po[2]}]
#Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {an_po[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_po[3]}]
#Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
set_property PACKAGE_PIN N2 [get_ports {an_po[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_po[4]}]
#Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
set_property PACKAGE_PIN N4 [get_ports {an_po[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_po[5]}]
#Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
set_property PACKAGE_PIN L1 [get_ports {an_po[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_po[6]}]
#Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
set_property PACKAGE_PIN M1 [get_ports {an_po[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_po[7]}]
...
set_property PACKAGE_PIN D4 [get_ports uart_tx_po]						
	set_property IOSTANDARD LVCMOS33 [get_ports uart_tx_po]
...
set_property PACKAGE_PIN F4 [get_ports ps2_clk_pi]						
	set_property IOSTANDARD LVCMOS33 [get_ports ps2_clk_pi]
	set_property PULLUP true [get_ports ps2_clk_pi]
##Bank = 35, Pin name = IO_L10N_T1_AD15N_35,					Sch name = PS2_DATA
set_property PACKAGE_PIN B2 [get_ports ps2_data_pi]					
	set_property IOSTANDARD LVCMOS33 [get_ports ps2_data_pi]	
	set_property PULLUP true [get_ports ps2_data_pi]
