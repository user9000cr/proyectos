...
set_property PACKAGE_PIN E16 [get_ports boton_we_ctrl_i]						
	set_property IOSTANDARD LVCMOS33 [get_ports boton_we_ctrl_i]
...
create_generated_clock -name clk_pll -source [get_ports clk_i] -divide_by 10 [get_pins reloj_10M/clk_10MHz]
